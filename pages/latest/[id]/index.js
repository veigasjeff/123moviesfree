  ...
  const uwatchfreeSchema = JSON.stringify([
    {
      ...
      image: [
        'https://onetwothreemoviesfree.onrender.com/wp-content/uploads/2023/05/favicon.ico'
      ],
      logo: {
        '@type': 'ImageObject',
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${latest.name} | 123 Movies Free`,
      ...
      {
        '@type': 'Person',
        '@id': 'https://onetwothreemoviesfree.onrender.com/author/latest/',
        name: 'Dr Trailer',
        url: 'https://onetwothreemoviesfree.onrender.com/author/latest/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        headline: `Watch ${latest.name} | 123 Movies Free`,
        datePublished: '2024-01-13T13:00:00+00:00',
        dateModified: '2024-01-13T13:13:00+00:00',
        ...
        image: latest.image,
        name: `Watch ${latest.name} | 123 Movies Free`,
        isPartOf: {
          '@id': `/${latest['latest.watch']}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch {latest && latest.name} | 123 Movies Free</title>
        ...
        <meta
          property='og:title'
          content={`${latest && latest.name} - 123 Movies Free`}
        />

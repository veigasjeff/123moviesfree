  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${moviesItem.name} | 123 Movies Free.`,
      ...
      },
      {
        ...
        headline: `Download ${moviesItem.name} | 123 Movies Free.`,
        datePublished: moviesItem.datePublished,
        dateModified: moviesItem.dateModified,
        ...
        name: `Download ${moviesItem.name} | 123 Movies Free.`,
        isPartOf: {
          '@id': `${moviesItem.siteurl}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        <title>
          {' '}
          Review {moviesItem && moviesItem.name} | 123 Movies Free.
        </title>
        ...
        <meta
          property='og:title'
          content={`${moviesItem && moviesItem.name} - 123 Movies Free.`}
        />
        <meta
